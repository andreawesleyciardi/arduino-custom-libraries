...
void loop() {
  ...
  sr.setAll(pinValues); 
  delay(1000);
/Users/andreaciardi/Documents/Arduino/libraries/ShiftRegister74HC595/src/ShiftRegister74HC595.h
  
  // read pin (zero based, i.e. 6th pin)
  uint8_t stateOfPin5 = sr.get(5);/Users/andreaciardi/Documents/Arduino/libraries/ShiftRegister74HC595/src/ShiftRegister74HC595.hpp
