...
#define OPCODE_HEARTBEAT_REQUEST     0x05
#define OPCODE_HEARTBEAT_RESPONSE    0x06
#define OPCODE_BLINK_COMMAND         0x07
#define OPCODE_PAIRING_SOLLECITATION 0x08
...
#define OPCODE_IDENTIFY_TARGET	 	 0x35
